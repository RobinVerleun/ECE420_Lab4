/*
The script to fetch the subset of the original data and add links to the node with no out going links 
The index is remapped to make it continuous in the resulting subset of data. Index start from 0.
